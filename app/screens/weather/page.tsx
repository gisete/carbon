import { getIpmaForecast, getIpmaIcon } from "@/lib/ipma";
...
export default async function WeatherScreen({ searchParams }: { searchParams: { humidity?: string } }) {
	// Fetch real data (passing the humidity override if present)
	const data = await getIpmaForecast(searchParams.humidity);
